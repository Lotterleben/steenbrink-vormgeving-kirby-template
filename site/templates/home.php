 ...
 * This home template renders content from others pages, the children of a `projektsammlung` page to display a nice gallery grid.
...
<main>
  ...
  if ($projektsammlungPage = page('projektsammlung')): ?>
  <ul class="grid">
    <?php foreach ($projektsammlungPage->children()->listed() as $album): ?>
    <li>
      <a href="<?= $album->url() ?>">
        <figure>
          <?php 
